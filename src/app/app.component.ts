...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title : 'Showcase Deals',component: ShowcaseDealsPage},
      { title : 'Showcase Place2Bizzer', component: ShowcasePlace2BizzPage},
      { title : 'Showcase Advertiser', component: ShowcaseAdvertiserPage}
    ];
